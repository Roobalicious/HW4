...
Original file is located at
    https://colab.research.google.com/drive/1hbNGasKgWQ3wX_PryMPqTT8yNbecdSzq
"""
...
medal = medals[~medals.iloc[:, 3].between(0, 1999, inclusive=False)]

px.parallel_categories(medal, dimensions=['Year','Medal', 'Gender'], color="Year")
...
election = pd.read_csv('/content/drive/MyDrive/Copy of DATA/2016elections.csv')
...
percent.plot(kind='bar', stacked=True, color=['red', 'blue', 'yellow', 'green'])
